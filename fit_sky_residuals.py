...
odir = '/Users/cabrera-ziri/Work/data/eso/reticulum/sky_residual_corrected7/'
...
def force_sky_correct(model,wl,x,wl_lo=860,wl_hi=870):
...
if __name__ == '__main__':
    ...
    for file in infiles:
        ...
        flx2,model = force_sky_correct(pca,wl,norm_flx[None,...],wl_lo=855.5,wl_hi=866.5)
